...
const ScooterDetail = ({ navigation }) => {
  return (
    <View style={styles.container}>
      ...
      <Image source={require('../images/scooter_2.png')} style={styles.img} />
      <View style={styles.cont3}>
        ...
        <Text style={styles.text}>
          Lorem ipsum dolor sit amet, consectutur adipsing elit, sed do eiusmod tempor inciduent ut labore et dolore magna
        </Text>
